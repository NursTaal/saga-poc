...
public class WalletService {
  private final WalletRepo repo; private final OutboxRepository outbox; private final ObjectMapper om;
  public WalletService(WalletRepo r, OutboxRepository o, ObjectMapper om){ this.repo=r; this.outbox=o; this.om=om; }
  ...
  public void handleDebit(UUID sagaId, UUID userId, UUID txnId, BigDecimal amount, boolean fail){
    try {
      ...
      acc.debit(amount); repo.save(acc);
