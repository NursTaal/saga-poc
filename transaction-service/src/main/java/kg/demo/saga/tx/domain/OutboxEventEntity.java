...
public class OutboxEventEntity {
  ...
  public OutboxEventEntity(String aggType,String aggId,String type,String payload){
    this.id=UUID.randomUUID(); this.aggregateType=aggType; this.aggregateId=aggId; this.type=type; this.payload=payload;
    this.status="NEW"; this.attempts=0; this.createdAt=Instant.now();
  }
  public UUID getId(){return id;} public String getType(){return type;} public String getPayload(){return payload;}
